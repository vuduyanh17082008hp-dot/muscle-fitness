...
export function WorkoutPlayer({
  ...
  /* =======================================================
     ...
     No setTimerRunning(false) inside effect.
  ======================================================= */
  ...
  function saveSet(
    ...
    if (
      ...
      setMessage(
        "Enter repetitions before completing the set.",
      );
  ...
  function skipExercise(
    ...
    startTransition(
      async () => {
        const result =
          await skipSessionExerciseAction(
            {
              sessionId,
  ...
  function replaceExercise(
    ...
    startTransition(
      async () => {
        const result =
          await replaceSessionExerciseAction(
            {
              sessionId,
  ...
  return (
    <div className="space-y-6 pb-32">
      ...
      <header className="rounded-3xl border border-white/10 bg-linear-to-br from-[#b58a52]/15 via-zinc-950 to-black p-5 shadow-2xl shadow-black/40 sm:p-7">
                        ...
                        >
                          ...
                          >
                            {set.completed ? (
                              ...
                              <span className="size-4 rounded border border-current" />
                            )}
                          </button>
                        </div>
                      ),
